...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_MINS, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, LGUI(KC_LSFT(KC_S)), LT(1,KC_GRV), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LALT, KC_LGUI, MO(1), KC_SPC, KC_ENT, TT(1), TT(2), TT(3)),
...
void encoder_update_user(uint8_t index, bool clockwise) {
  switch(biton32(layer_state)) {
    ...
    print("Encoder activated on ", biton32(layer_state), " layer.\n");
    default:
      print("Encoder activated on default layer.\n");
      clockwise ? tap_code(KC_DOWN) : tap_code(KC_UP);
      break;
    case _LOWER:
      print("Encoder activated on _LOWER layer.\n");
      clockwise ? tap_code(KC_RIGHT) : tap_code(KC_LEFT);
      break;
    case _RAISE:
      print("Encoder activated on _RAISED layer.\n");
